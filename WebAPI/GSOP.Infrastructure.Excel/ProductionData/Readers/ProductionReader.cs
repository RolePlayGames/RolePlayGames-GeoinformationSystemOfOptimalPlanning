...
public class ProductionReader : ModelReader<ProductionModel>
{
    protected override int WorkSheetNum => 9;

    protected override ProductionModel? ReadModel(ExcelRange cells, int rowNum)
    {
